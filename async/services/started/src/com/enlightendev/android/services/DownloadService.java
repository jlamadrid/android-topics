...
public class DownloadService extends Service {
     ...
     */
    public static Intent makeIntent(Context context, Uri uri, Handler downloadHandler) {

        // Create the Intent that's associated to the DownloadService class.
        Intent intent = new Intent(context, DownloadService.class);

        // Set the URI as data in the Intent.
        intent.setData(uri);

        // Create and pass a Messenger as an "extra" so the DownloadService can send back the pathname.
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // Create a Message that will be sent to ServiceHandler to retrieve an image based on the URI in the Intent.
        Message message =
                mServiceHandler.makeDownloadMessage(intent, startId);

        // Send the Message to ServiceHandler to retrieve an image based on contents of the Intent.
        mServiceHandler.sendMessage(message);

        // Don't restart the DownloadService automatically if its process is killed while it's running.
    ...
    private final class ServiceHandler extends Handler {
        ...
        /**
         * A factory method that creates a Message that contains information on the image to download and how to stop the
         * Service.
         */
         ...
         * messenger.
         */
        private void sendPath(Messenger messenger, String pathname) {
         ...
         * @throws IOException
         */
        private File getTemporaryFile(final Context context, final String url) throws IOException {
            return context.getFileStreamPath(Base64.encodeToString(url.getBytes(), Base64.NO_WRAP)
         ...
         * @throws IOException
         */
        private int copy(final InputStream in, final OutputStream out) throws IOException {
        ...
        public String downloadImage(final Context context,
            ...
            try {
                ...
                Log.e(getClass().getName(), "Exception while downloading. Returning null.");
